...
exports.config = {
    ...
    suites: {
        smokeSuite: ['test/specs/vtiger/createDocument.js'],
        regressionSuite: ['test/specs/vtiger/createCampaign.js','test/specs/vtiger/createContact.js','test/specs/vtiger/createOrganization.js','test/specs/vtiger/createProduct.js']
    },
    // Patterns to exclude.
    exclude: [
        // 'path/to/excluded/files'
        'test/specs/launchbrowser.js',
        'test/specs/vtiger/errorMsg.js',
